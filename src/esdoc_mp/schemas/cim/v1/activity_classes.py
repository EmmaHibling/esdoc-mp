...
def _conformance():
    ...
    return {
        ...
        'properties' : [
            ...
            ('requirements', 'activity.numerical_requirement', '1.N', 'Points to the NumericalRequirement that the simulation in question is conforming to.'),
            ('requirements_references', 'shared.doc_reference', '1.N', None),
